...
export const Footer: React.FC = () => {
  return (
    <footer className="h-12 bg-[black] border-t border-white/5 flex items-center justify-between px-8 text-[10px] text-white/40 uppercase tracking-widest font-bold select-none flex-shrink-0 z-20">
      <div className="flex items-center gap-6">
        <span className="flex items-center gap-1.5 text-green-400">
          <span className="w-1.5 h-1.5 rounded-full bg-green-400 animate-pulse"></span>
          Real-time AI Gemini Translation Active
        </span>
        <span className="text-[white] flex items-center gap-1 hidden sm:flex">
      ...
      <div className="flex items-center gap-6">
        ...
        <span className="text-[white]">Global Protocol v4.2</span>
      </div>
    </footer>
  );
};
